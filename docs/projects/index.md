...
.. admonition:: Tip
    ...
    .. markdown::
      ...
      In the context of OC4IDS, the term 'project' is defined as the delivery of a set of infrastructure assets in a specified location, generally under a single managing entity (project owner) and budget authority: for example, the construction of a bridge, highway junction or building.
