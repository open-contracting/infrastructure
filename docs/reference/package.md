...
You can view an interactive version of the project package schema below (requires JavaScript) or [download it here](../../build/current_lang/project-package-schema.json).
